...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
    const getObjects = async (objectType) => {
        try {
            const response = await axios.get(`${API_BASE_URL}/Objects/${objectType}`, {
                headers: {
                    'X-PAN-KEY': API_KEY,
    ...
    switch (request.params.name) {
        ...
        case 'create_object': {
            const { object_type, object_data } = request.params.arguments;
            try {
                const objectTypeMap = {
                    'address': 'Addresses',
                ...
                const response = await axios.post(`${API_BASE_URL}/Objects/${objectTypeMap[object_type]}`, object_data, {
                    headers: {
                        'X-PAN-KEY': API_KEY,
                        'Accept': 'application/json'
                    }
        ...
        case 'update_object': {
            const { object_type, object_name, object_data } = request.params.arguments;
            try {
                const objectTypeMap = {
                    'address': 'Addresses',
                    'address-group': 'AddressGroups',
                ...
                const response = await axios.put(`${API_BASE_URL}/Objects/${objectTypeMap[object_type]}/${object_name}`, object_data, {
                    headers: {
                        'X-PAN-KEY': API_KEY,
                        'Accept': 'application/json'
                    }
        ...
        case 'delete_object': {
            const { object_type, object_name } = request.params.arguments;
            try {
                const objectTypeMap = {
                    'address': 'Addresses',
                    'address-group': 'AddressGroups',
                ...
                const response = await axios.delete(`${API_BASE_URL}/Objects/${objectTypeMap[object_type]}/${object_name}`, {
                    headers: {
                        'X-PAN-KEY': API_KEY,
                        'Accept': 'application/json'
                    }
